...
export function Hero() {
  return (
    <div className="h-full flex flex-col md:flex-row gap-8 md:gap-12 items-center max-w-7xl mx-auto w-full pb-[125px] md:pb-0 pt-[75px] md:pt-0">
      ...
      <div className="flex-shrink-0 w-full md:w-[30%] space-y-3">
        ...
        <div className="space-y-0.5">
          <h1 className="tracking-tight text-[38px] whitespace-nowrap font-semibold">
            Hiya, I{'\u2019'}m Rachael!
          </h1>
          
          <p className="text-sm text-neutral-600 text-[17px]">
