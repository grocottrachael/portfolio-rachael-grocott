      ...
      <div className="grid grid-cols-6 gap-3">
        ...
        <div className="col-span-6 md:col-span-2 md:row-span-2 bg-neutral-50 rounded-xl p-4 flex flex-col md:min-h-[200px] order-4 md:order-none">
          <div>
            ...
            <div className="text-[10px] text-neutral-500 space-y-0.5">
              <div className="text-[14px] text-[rgb(82,82,82)]">Clear IA • Intuitive UI • Visual Polish • Fast Prototyping • Thoughtful Systems • Interaction Design • Research & Testing • Product Thinking • Cross-team Collaboration • Clear Communication</div>
            </div>
          </div>
        </div>
